...
> ⚠️ **First launch:** The app is unsigned. If you see "damaged and can't be opened":
> ```bash
> xattr -cr ~/Downloads/Ledger-0.1.0-arm64.dmg
> ```
> Then open the DMG and drag Ledger to Applications. Alternatively, right-click → Open twice.
